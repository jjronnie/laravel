...
const text = typewriter.getAttribute('data-text'); // Get the text from the HTML element
let index = 0;
...
function typeWriter() {
  ...
  if (index > text.length) {
    index = 40; // Reset index to start over
  }

  setTimeout(typeWriter, 110); // Adjust typing speed here
}
